...
Third, the browser is the universal runtime. No window manager plugins, no platform-specific builds, no Electron wrapper. You run `npx @jhizzard/termdeck` and it opens in your default browser. That is the entire setup.
...
<Callout variant="tip">No config files, no build step, no dependencies to manage. Just run `npx @jhizzard/termdeck` and your dashboard opens in the browser.</Callout>
