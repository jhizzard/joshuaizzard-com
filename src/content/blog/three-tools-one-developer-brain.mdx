...
date: "2026-04-12"
description: "TermDeck captures. Engram stores. Rumen reasons. The brain doesn't sleep when you close your laptop."
...
| | **Karpathy (Obsidian wiki)** | **Mem0** | **Ruflo** | **TermDeck + Engram + Rumen** |
|---|---|---|---|---|
...
| **MCP support** | No | No | No | Engram is a native MCP server — works with any compatible client |
...
<Callout variant="insight">The key differentiator is the closed loop: TermDeck captures passively, Engram stores durably, and Rumen reasons autonomously — even after you close your laptop. No other approach connects all three layers.</Callout>
...
- **Engram**: [github.com/jhizzard/engram](https://github.com/jhizzard/engram) — persistent memory MCP server
