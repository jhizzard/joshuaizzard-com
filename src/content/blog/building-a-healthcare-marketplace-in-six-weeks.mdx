...
<PullQuote>194K data points, 12K locations, real-time bidding, AI-powered matching, and Stripe Connect — solo, in six weeks.</PullQuote>
...
<Callout variant="insight">Spending the first week entirely on financial modeling and data architecture — before touching any UI — informed every product decision downstream. Understanding the shape of the data made six weeks possible.</Callout>
